...
public class LongRangeUltraSonic {
		AnalogInput sensor;
		...
		boolean inaccurate;
		public LongRangeUltraSonic(int analogport){
		...
		public double getDistance(){
			double currentDistance = ((sensor.getAverageVoltage()/.00488281)/1.27);//Vcc/5120 Vcc =.00097656258 supplied voltage (5v) v/vcc/5120 = mm /25.4 = in. - 2 inches because range 0 is the inside of the cone
		...
		public double getRawDistance(){
			return ((sensor.getAverageVoltage()/.00488281)/1.27)-2;
		}
}
